        ...
        http
                ...
                .exceptionHandling(eh -> eh
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            ApiErrorResponse body = new ApiErrorResponse(Instant.now(), 401, "UNAUTHORIZED",
                                    "Authentification requise ou token invalide/expiré", request.getRequestURI(), null);
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            ApiErrorResponse body = new ApiErrorResponse(Instant.now(), 403, "ACCESS_DENIED",
                                    "Accès refusé : droits insuffisants pour cette action", request.getRequestURI(), null);
                            response.getWriter().write(objectMapper.writeValueAsString(body));
                        })
                )
